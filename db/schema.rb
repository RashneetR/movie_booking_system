ActiveRecord::Schema.define(version: 20_181_015_151_308) do
  create_table 'movie_interests', options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'movie_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[movie_id user_id], name: 'index_movie_interests_on_movie_id_and_user_id', unique: true
  ...
  create_table 'movie_theatres', id: false, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    t.bigint 'movie_id'
    t.bigint 'theatre_id'
    t.index %w[movie_id theatre_id], name: 'index_movie_theatres_on_movie_id_and_theatre_id', unique: true
  ...
  create_table 'reviews', options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[user_id movie_id], name: 'index_reviews_on_user_id_and_movie_id', unique: true
